...
class CatalogTourItem extends StatefulWidget {
  final Locale locale;
  final String id;
  final String image;
  ...
  @override
  _CatalogTourItemState createState() => _CatalogTourItemState();
}

class _CatalogTourItemState extends State<CatalogTourItem> {
  @override
